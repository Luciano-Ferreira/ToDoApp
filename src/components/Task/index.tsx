...
export function Task({ id, description, isDone, onDelete, onCheck }: Props) {
  ...
  return (
    <div className={styles.listItem}>
      <input type="checkbox" checked={isDone} onChange={handleCheckTask} />
      {isDone ? <span className={styles.isDone}>{description}</span> : <span>{description}</span>}
      <button
